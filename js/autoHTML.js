...
for (var i = 0; i <= flappyArray.length - 1; i++) {
	if(flappyArray[i][1] == 1) { //Image Ex. Paddle
		div.innerHTML = div.innerHTML + '<p class="form-label">' + flappyArray[i][0] + ': </p>  <input type="file" theme="flappy" name="' + flappyArray[i][0]+ '" class="formObject" rt-target="'+ flappyArray[i][0]+'Image"> <br>';
