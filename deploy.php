 ...
 * @var string
 */
if (!defined('REMOTE_REPOSITORY')) define('REMOTE_REPOSITORY', 'https://github.com/aupadhyay/game-gen.git');
/**
 ...
 */
if (!defined('TARGET_DIR')) define('TARGET_DIR', '/var/www/html/game-gen/');
/**
