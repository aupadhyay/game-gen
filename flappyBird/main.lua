...
function init()
	...
	for i=1,3 do
		...
		pipesTop[i] = display.newImageRect("images/TopPipes.png", 60, math.random(20,_H-pipeGap-20-ground1.height))
		...
		pipesBottom[i] = display.newImageRect("images/BottomPipes.png", 60, _H - pipeGap - pipesTop[i].height - ground1.height)
